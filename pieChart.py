...
class LegendTree(GridLayout):
    ...
    def _update_rect(self, instance, value):
        self.legend.pos = (instance.parent.pos[0], instance.parent.pos[1])
        self.pos = (instance.parent.pos[0] - 20, instance.parent.pos[1] - 50)
...
class Legend(FloatLayout):
    ...
    def _update_rect(self, instance, value):
        ...
        self.label.pos = (instance.pos[0] + 180, instance.pos[1] + 60)
...
class Pie(FloatLayout):
    ...
    def _update_temp(self, instance, value):
        for i in self.temp:
            i.pos = (instance.parent.pos[0] + 100, instance.parent.pos[1] + 60)
